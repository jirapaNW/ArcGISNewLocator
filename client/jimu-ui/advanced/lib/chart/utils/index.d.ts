...
import { type WebMapWebChart, type CalculatedMinMaxBoundsPayload, type LegendItemVisibility, type WebChartDataTypes, type ActionModes, type SelectionData, type ValidationStatus, type NotifyOptions } from 'arcgis-charts-components';

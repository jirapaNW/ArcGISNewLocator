...
export declare function getThemeColor(color: any, theme: any): any;
export declare const COLOR_VARIABLE_REGEX: RegExp;
export declare const toColorVariable: (name: string, index?: number | string) => string;
export declare const toReferenceColorVariable: (name: string, index?: number | string) => string;

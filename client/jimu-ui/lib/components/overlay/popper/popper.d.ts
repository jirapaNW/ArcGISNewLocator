 ...
 * ```
 */
export declare const _Popper: React.MemoExoticComponent<React.ForwardRefExoticComponent<_PopperProps & Omit<PopperCoreProps, "children" | "version" | "reference"> & React.RefAttributes<import("@popperjs/core/lib/types").Instance>>>;
/**
 * The `Popper` component is used to display some content adjacent to, but connected with, another component.
 *
 * ```ts
 ...
 * ```
 */
export declare const Popper: import("@emotion/styled").StyledComponent<Omit<_PopperProps & Omit<PopperCoreProps, "children" | "version" | "reference"> & React.RefAttributes<import("@popperjs/core/lib/types").Instance>, "ref"> & {
    ref?: React.Ref<import("@popperjs/core/lib/types").Instance>;
}, {}, {}>;

 ...
 * @ignore
 */
export declare enum TreeSelctionStyle {
    /**
...
export interface TreeItemInternalActionMapType {
    ...
    /**
     * Fired when checking if a dragged item can be dropped into the current item.
     * The drop-into action could be triggered by one of the following methods:
     * `to-inside` to the current item directly.
...
export interface BaseTreeListProps extends TreeItemActionMapType {
    ...
    */
    ...
    /**
     * Single line text is displayed. Only for layer selctor now.
     * @default false
     * @ignore
     */

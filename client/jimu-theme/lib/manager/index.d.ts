...
declare const mapping: {
    ...
    createMappedThemeOption: (classicTheme: import("jimu-core").ThemeVariables, compStyles: import("jimu-theme/lib/manager/theme-module/type").StyleFunctions, shadeOptions: _mapping.color.ShadeOptions) => import("jimu-theme").ThemeOptions;
    whetherIsNewTheme: (module: import("jimu-theme/lib/manager/theme-module/type").ThemeModule) => boolean;
    createMixedTheme: (module?: import("jimu-theme/lib/manager/theme-module/type").ThemeModule, inputThemeOptions?: import("jimu-core").ImmutableObject<import("jimu-theme/lib/manager/theme-module/type").MixedRawThemeOptions>, mixins?: import("jimu-theme").ThemeMixinsOptions) => import("jimu-core").IMThemeVariables;

...
interface SignInParams {
    ...
    forceLogin?: boolean;
    /** The url of federated service if sigin in to a federated service. Optional. @ignore */
...
export declare class SessionManager {
     ...
     *
     *   Because the token is used as the chache key, if a token is invalid, which cache will be removed
     *
     * @ignore
     */
     ...
     */
    useDialogToSetClientIdToConnectiosOfAppConfigAndSignIn(portalUrl: string, needToSignIn?: boolean, serviceUrl?: string, forceLogin?: boolean): Promise<any>;
    /**
     * @ignore
     ...
     * @param serverUrl
     */
    getSessionFromWebTierServer(serverUrl: string): Promise<ArcGISIdentityManager>;
    /****************************************************************
     ...
     *    a), builder evn;
     *    b), app env and it's not public app (non-dev editiotn app)
     *

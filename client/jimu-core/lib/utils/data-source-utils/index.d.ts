...
/**
 * Check if field domain is affected by typeIdField.
 * @ignore
 */
...
export declare function getJSAPILayer(dataSource: ArcGISQueriableDataSource): __esri.Layer;
...
export declare function getUsedFieldsFromFeatureLayerQueryParams(query: ArcGISQueryParams, dataSource: DataSource, queryType: 'feature' | 'id' | 'count'): string[];
/**

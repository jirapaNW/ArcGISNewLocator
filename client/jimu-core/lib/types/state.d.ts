...
export interface DataSourceInfo {
     ...
     * The data source will use `selectOptions` to query records and save IDs of the query result to `selectedIds`. So if widgets only need to hightlight the selected records, please just watch changes of `selectedIds`.
     */

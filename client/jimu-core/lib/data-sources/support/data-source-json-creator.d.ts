...
import { AllDataSourceTypes } from '../interfaces/common-data-source-interface';
...
export declare function createDataSourceJsonByJSAPILayer(dsId: string, layer: __esri.Layer, dsJsonInConfig?: IMDataSourceJson, schemaInConfig?: Immutable.ImmutableObject<DataSourceSchema>): IMDataSourceJson;
/**

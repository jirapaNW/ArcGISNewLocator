...
import { type DataSource, type DataSourceConstructorOptions, type DataRecord, DataSourceStatus, type SelectOptions, type QueryResult, type UsedFieldsOptions } from '../interfaces';
/**
...
export declare abstract class AbstractDataSource implements DataSource {
    ...
    clearSelection(): void;
    updateSelectionInfoOfDerivedDssAndChangeUrl(options: SelectOptions, derivedFromDataSource?: DataSource, forceCheck?: boolean): void;
    protected updateSelectionInfoOfDerivedDss(options: SelectOptions, derivedFromDataSource?: DataSource, forceCheck?: boolean): void;
    protected changeUrl(options: SelectOptions, derivedFromDataSource?: DataSource): void;
